...
<head>
    ...
    <title><dec:title default="Customer Page"/></title>
...
<!-- Header -->
<%@ include file="/common/customerr/header.jsp" %>
<!-- End Header -->
...
<div class="main-container ace-save-state" id="main-container">
    ...
    <!-- Begin menu -->
    <%@ include file="/common/customerr/menu.jsp" %>
    <!-- End menu -->
    ...
    <!-- Begin footer -->
    <%--<%@ include file="/common/customerr/footer.jsp" %>--%>
    <!-- end footer -->
